    ...
    return GetBuilder<AuthController>(
        builder: (authController) {
          ...
          return Column(
              ...
              children: [
              Text('login'.tr, style: robotoBold.copyWith(fontSize: 16)),
            // Align(
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('remember_me'.tr, style:  const TextStyle(
            ...
            CustomButtonWidget(
              ...
              buttonText: 'login'.tr,
              radius: isDesktop ? Dimensions.radiusSmall : 8,
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('do_not_have_account'.tr, style:
              const TextStyle(
                  fontFamily: AppConstants.fontFamily,
                  fontWeight: FontWeight.w400,
                  fontSize: 12,
