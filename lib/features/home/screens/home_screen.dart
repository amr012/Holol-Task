              ...
              child: ResponsiveHelper.isDesktop(context) ? WebHomeScreen(
                ...
                slivers: [
                  ...
                  SliverAppBar(
                    ...
                    backgroundColor:
                    ResponsiveHelper.isDesktop(context) ? Colors.transparent :
                    Colors.white,
                                        ...
                                        child: GetBuilder<LocationController>(builder: (locationController) {
                                          return Column(mainAxisSize: MainAxisSize.min, children: [
                                            ...
                                            Row(children: [
                                              ...
                                              ) : Icon(Icons.location_on, size: 20, color:  Color(0xff1E1E1E)),
                                              ...
                                              Flexible(
                                                child: Text(
                                                  ...
                                                  style: robotoRegular.copyWith(
                                                    color:
                                                    Color(0xff1E1E1E), fontSize: Dimensions.fontSizeSmall/* - (scrollingRate * Dimensions.fontSizeSmall)*/,
                                                  ),
                                          ...
                                          child: Stack(children: [
                                            Transform.translate(
                                              ...
                                              Icon(Icons.notifications_outlined,
                                                  size: 25, color: Color(0xff1E1E1E)),
                                          ),
                          ...
                          child: InkWell(
                            ...
                            //  transform: Matrix4.translationValues(0, -3, 0),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: Color(0xff7C0631),width: 1)
                              ),
                              child: Row(children: [
                                Image.asset(Images.searchHome, width: 25, height: 25),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Expanded(child: Text('search_restaurants'.tr, style: robotoRegular.copyWith(
