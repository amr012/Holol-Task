      ...
      child: Container(
       // width: 171,
        ...
        decoration: !fromWeb ? BoxDecoration(
          color:
        //  localizationController.selectedLanguageIndex == index ? Theme.of(context).primaryColor.withOpacity(0.05) :
          const Color(0xffFEFCE0),
          borderRadius: BorderRadius.circular(Dimensions.radiusLarge),
          border: localizationController.selectedLanguageIndex == index ?
          Border.all(color: Theme.of(context).primaryColor.withOpacity(0.2)) : null,
        ) : BoxDecoration(
        ...
        child: Column(children: [
          ...
          Image.asset(languageModel.imageUrl!, width: 55, height: 55),
