            ...
            children: [
              Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('cuisines'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600)),
                  InkWell(
                      onTap: (){
                        Get.toNamed(RouteHelper.getCuisineRoute());
                      },
                      child: Text('view_all'.tr, style: robotoBold.copyWith(fontSize: 12, fontWeight: FontWeight.w600))),
